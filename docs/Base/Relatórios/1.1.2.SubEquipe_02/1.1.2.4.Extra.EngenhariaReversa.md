...
A bibliografia acadêmica geral e as fontes complementares da SubEquipe_02 estão catalogadas no documento central de [1.1.2.5. Referências — SubEquipe_02](/Base/Relatórios/1.1.2.SubEquipe_02/1.1.2.5.Referencias.md). As referências documentais empíricas específicas desta análise de engenharia reversa são:
...
| 1.4 | 18/09/2026 | Vinculação com o catálogo central de referências 1.1.2.5 | Davi Severiano Freitas | Daniel de Oliveira Lira, Mateus Rodrigues Barreto, Pedro Henrique Freire Rodrigues |