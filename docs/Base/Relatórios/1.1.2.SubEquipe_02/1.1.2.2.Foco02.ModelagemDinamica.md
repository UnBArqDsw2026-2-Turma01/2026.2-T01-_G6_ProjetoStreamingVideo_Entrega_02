...
![Diagrama de Recarga](../../../assets/diagramas_sequencia/recarga.svg)
...
![Diagrama de Doação](../../../assets/diagramas_sequencia/doacao.svg)
...
![Diagrama de Saque](../../../assets/diagramas_sequencia/saque.svg)
...
| Pagamento de recarga com saldo do criador | Achado SQ08 | [Extra — Eng. Reversa](1.1.2.4.Extra.EngenhariaReversa.md) | O caminho alternativo do `alt` decorre da possibilidade de usar o saldo em compras internas |
| Fluxo de Doação | Mensagem paga destacada (`<plataforma-B>`) | [Extra — Eng. Reversa](1.1.2.4.Extra.EngenhariaReversa.md) | Os achados SC01–SC06 fundamentam as faixas de destaque e a ausência de estorno em caso de remoção |
| Verificação de perfil habilitado a receber | Achados SQ02 e SQ09 | [Extra — Eng. Reversa](1.1.2.4.Extra.EngenhariaReversa.md) | Justifica a distinção entre criador monetizado e não monetizado |
| Fluxo de Saque | Achados SQ10–SQ16 | [Extra — Eng. Reversa](1.1.2.4.Extra.EngenhariaReversa.md) | Ciclo periódico, limite mínimo por método, retenção por dados incompletos e taxas do método |
