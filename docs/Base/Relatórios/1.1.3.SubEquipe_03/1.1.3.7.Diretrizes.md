# Diretrizes do Relatório — SubEquipe_03
...
| -- | -- |
| FOCO_01: Modelagem Estática (participantes, metodologia, modelo) | [1.1.3.1](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.1.Foco01.ModelagemEstatica.md) |
| FOCO_02: Modelagem Dinâmica (participantes, metodologia, modelo) | [1.1.3.2](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.2.Foco02.ModelagemDinamica.md) |
| FOCO_03: IA Generativa (participantes, lições aprendidas, senso crítico) | [1.1.3.3](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.3.Foco03.IAGenerativa.md) |
| Metodologia | [1.1.3.4](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.4.Metodologia.md) e seção própria em cada foco |
| Rastreabilidade & Elos com Outros Artefatos | [1.1.3.5](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.5.Rastreabilidade.md) |
| Versionamentos & Participações | [1.1.3.6](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.6.Versionamentos.md) |
| Referências | [1.1.3.8](/Base/Relatórios/1.1.3.SubEquipe_03/1.1.3.8.Referencias.md) |
